...
class MetricsExplainerCreator:
    ...
    def add_section_3_crate_costs(self, start_row):
        ...
        crate_data = [
            ...
            ["   - Crate_Equivalent_Weight = Number_of_Crates × 2kg", "", "", "", "", "", "", "", "", ""],
            ...
            ["Calculation:", "", "", "", "", "", "", "", "", ""],
            ["- Crate equivalent: 10 × 2 = 20kg", "", "", "", "", "", "", "", "", ""],
            ["- Total equivalent: 300kg + 20kg = 320kg", "", "", "", "", "", "", "", "", ""],
            ["- Egg allocation: (20 ÷ 320) × ₦30,000 = ₦1,875", "", "", "", "", "", "", "", "", ""],
            ["- Per crate: ₦1,875 ÷ 10 = ₦187.50 per crate", "", "", "", "", "", "", "", "", ""],
            ["", "", "", "", "", "", "", "", "", ""],
        ]
    ...
    def add_section_5_scenarios(self, start_row):
        ...
        scenario_data = [
            ...
            ["Processing:", "", "", "", "", "", "", "", "", ""],
            ["- Convert crates to space equivalent (20 × 2kg = 40kg)", "", "", "", "", "", "", "", "", ""],
            ["- Total equivalent weight = 400kg + 40kg = 440kg", "", "", "", "", "", "", "", "", ""],
            ["- Allocate cost: Eggs get 40/440, Products get 400/440", "", "", "", "", "", "", "", "", ""],
            ["", "", "", "", "", "", "", "", "", ""],
            ["EDGE CASES:", "", "", "", "", "", "", "", "", ""],
    ...
    def add_section_8_faq(self, start_row):
        ...
        faq_data = [
            ...
            ["", "", "", "", "", "", "", "", "", ""],
            ["Q4: Why use 2kg equivalent for crates?", "", "", "", "", "", "", "", "", ""],
            ["A4: This represents space/volume equivalency in transportation:", "", "", "", "", "", "", "", "", ""],
            ["    • 1 egg crate occupies similar space as 2kg of products", "", "", "", "", "", "", "", "", ""],
